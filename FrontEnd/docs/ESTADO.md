...
- **Sin code-splitting, bundle único y creciendo** (AUDIT_8 #1/#2) — `grep "lazy(" src/shared/routes/AppRoutes.tsx` → 0 resultados. Bundle hoy: 1.537,42 kB (era 1.470,62 kB en la auditoría, 1.526,70 kB antes de Tanda 9) — empeoró, no mejoró.
