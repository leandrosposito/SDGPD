...
export const ORDERS_MOCK_DATA: Order[] = [
  {
    ...
    items: [
      { id: asOrderLineId('oi-101'), sku: 'ACE-GIR-15', name: 'Aceite Girasol 1.5L', quantity: 12, unitPrice: 2100, subtotal: 25200 },
      { id: asOrderLineId('oi-102'), sku: 'YER-TAR-1K', name: 'Yerba Taragui 1kg', quantity: 6,  unitPrice: 3600, subtotal: 21600 },
      { id: asOrderLineId('oi-103'), sku: 'GAL-SUR-200', name: 'Galletitas Surtidas 200g', quantity: 1, unitPrice: 450, subtotal: 450 },
    ],
    history: [
  ...
  },
  {
    ...
    notes: '',
    items: [
      { id: asOrderLineId('oi-201'), sku: 'ACE-GIR-15', name: 'Aceite Girasol 1.5L', quantity: 48, unitPrice: 2100, subtotal: 100800 },
      { id: asOrderLineId('oi-202'), sku: 'ACE-OLI-05', name: 'Aceite Oliva 500ml', quantity: 12, unitPrice: 5600, subtotal: 67200 },
      { id: asOrderLineId('oi-203'), sku: 'YER-UNI-05', name: 'Yerba Union 500g', quantity: 20, unitPrice: 1520, subtotal: 30400 },
    ],
    history: [
  ...
  },
  {
    ...
    notes: '',
    items: [
      { id: asOrderLineId('oi-301'), sku: 'GAL-SUR-200', name: 'Galletitas Surtidas 200g', quantity: 24, unitPrice: 450, subtotal: 10800 },
      { id: asOrderLineId('oi-302'), sku: 'YER-UNI-05', name: 'Yerba Union 500g', quantity: 3, unitPrice: 1520, subtotal: 4560 },
    ],
    history: [
  ...
  },
  {
    ...
    notes: '',
    items: [
      { id: asOrderLineId('oi-401'), sku: 'ACE-GIR-15', name: 'Aceite Girasol 1.5L', quantity: 24, unitPrice: 2100, subtotal: 50400 },
      { id: asOrderLineId('oi-402'), sku: 'GAL-SUR-200', name: 'Galletitas Surtidas 200g', quantity: 30, unitPrice: 450, subtotal: 13500 },
    ],
    history: [
  ...
  },
  {
    ...
    items: [
      { id: asOrderLineId('oi-501'), sku: 'ACE-OLI-05', name: 'Aceite Oliva 500ml', quantity: 6, unitPrice: 5600, subtotal: 33600 },
    ],
    history: [
  ...
  },
  {
    ...
    notes: '',
    items: [
      { id: asOrderLineId('oi-601'), sku: 'YER-TAR-1K', name: 'Yerba Taragui 1kg', quantity: 12, unitPrice: 3600, subtotal: 43200 },
    ],
    history: [
