...
// Tipo de entrada (pre-coercion) del schema, para tipar useForm().
// z.coerce.number() acepta unknown como input y devuelve number como output;
// eso hace que el Resolver de zodResolver(schema) no encaje con
// useForm<ProductFormValues> a secas (ProductFormValues es el output).
